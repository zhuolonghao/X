...
close_final.set_index(['Date', 'ticker'])\
    ...
    .to_excel('MOVING_to_BQR7_vol.xlsx')

######################
automate = pd.read_excel('MOVING_to_BQR7_vol.xlsx').sort_values(['ticker', 'rn'])
...
result_ret['BQR7_asap_20'] = asap3['cum_ret_exit_20'].dropna().to_list()
result_ret['BQR7_asap_30'] = asap3['cum_ret_exit_30'].dropna().to_list()
...
result_ret['BQR7_move10_ext20'] = h2c_material_10['cum_ret_exit_20'].dropna().to_list()
result_ret['BQR7_move10_ext30'] = h2c_material_10['cum_ret_exit_30'].dropna().to_list()
...
result_ret['BQR7_move20_ext20'] = h2c_material_20['cum_ret_exit_20'].dropna().to_list()
result_ret['BQR7_move20_ext30'] = h2c_material_20['cum_ret_exit_30'].dropna().to_list()
...
result_ret['BQR7_move30_ext20'] = h2c_material_30['cum_ret_exit_20'].dropna().to_list()
result_ret['BQR7_move30_ext30'] = h2c_material_30['cum_ret_exit_30'].dropna().to_list()
...
result_ret['BQR7_down10_ext20'] = h2c_down_10['cum_ret_exit_20'].dropna().to_list()
result_ret['BQR7_down10_ext30'] = h2c_down_10['cum_ret_exit_30'].dropna().to_list()
...
result_ret['BQR7_down20_ext20'] = h2c_down_20['cum_ret_exit_20'].dropna().to_list()
result_ret['BQR7_down20_ext30'] = h2c_down_20['cum_ret_exit_30'].dropna().to_list()
...
result_ret['BQR7_down30_ext20'] = h2c_down_30['cum_ret_exit_20'].dropna().to_list()
result_ret['BQR7_down30_ext30'] = h2c_down_30['cum_ret_exit_30'].dropna().to_list()
...
with pd.ExcelWriter("strategy_BQR7.xlsx", engine="openpyxl") as writer:
