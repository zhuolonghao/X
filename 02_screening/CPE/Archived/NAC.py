...
close_final.set_index(['Date', 'ticker'])\
    ...
    .to_excel('NAC_vol.xlsx')

######################
automate = pd.read_excel('NAC_vol.xlsx').sort_values(['ticker', 'rn'])
...
result_ret['nac_asap_20'] = asap3['cum_ret_exit_20'].dropna().to_list()
result_ret['nac_asap_30'] = asap3['cum_ret_exit_30'].dropna().to_list()
...
result_ret['nac_move10_ext20'] = h2c_material_10['cum_ret_exit_20'].dropna().to_list()
result_ret['nac_move10_ext30'] = h2c_material_10['cum_ret_exit_30'].dropna().to_list()
...
result_ret['nac_move20_ext20'] = h2c_material_20['cum_ret_exit_20'].dropna().to_list()
result_ret['nac_move20_ext30'] = h2c_material_20['cum_ret_exit_30'].dropna().to_list()
...
result_ret['nac_move30_ext20'] = h2c_material_30['cum_ret_exit_20'].dropna().to_list()
result_ret['nac_move30_ext30'] = h2c_material_30['cum_ret_exit_30'].dropna().to_list()
...
result_ret['nac_down10_ext20'] = h2c_down_10['cum_ret_exit_20'].dropna().to_list()
result_ret['nac_down10_ext30'] = h2c_down_10['cum_ret_exit_30'].dropna().to_list()
...
result_ret['nac_down20_ext20'] = h2c_down_20['cum_ret_exit_20'].dropna().to_list()
result_ret['nac_down20_ext30'] = h2c_down_20['cum_ret_exit_30'].dropna().to_list()
...
result_ret['nac_down30_ext20'] = h2c_down_30['cum_ret_exit_20'].dropna().to_list()
result_ret['nac_down30_ext30'] = h2c_down_30['cum_ret_exit_30'].dropna().to_list()
...
with pd.ExcelWriter("strategy_nac.xlsx", engine="openpyxl") as writer:
